...
class Infrastructure(models.Model):
    ...
    utilisateur_mise_a_jour_infra = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name='updates',default='admin')
...
class Machine(models.Model):
    ...
    description = models.TextField(default="/")
    adresse_ip = models.CharField(max_length=15, default='0.0.0.0', blank=True)
